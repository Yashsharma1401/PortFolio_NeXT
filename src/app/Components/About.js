  ...
  const skills = [
    {
      ...
      desc: "React.js, modern UI/UX, and state management",
    ...
    },
    {
      ...
      desc: "Scalable REST APIs with Node.js & Express",
    ...
    },
    {
      ...
      desc: "Data modeling and integration",
    ...
    },
    {
      icon: "🎨",
      title: "UI Libraries",
      desc: "Reusable, accessible components",
      color: "from-orange-500 to-red-500",
      percentage: 85,
      techStack: ["Tailwind CSS", "Bootstrap", "Material UI"],
    },
  ];

  const stats = [
    { number: "8.11", label: "CGPA (B.Tech)" },
    { number: "10+", label: "Projects Built" },
    { number: "95%", label: "Lighthouse Accessibility" },
  ...
  const education = [
    {
      ...
      field: "DBATU University",
      institution: "2020 – 2024 | CGPA: 8.11 / 10",
      year: "2024",
      icon: "🎓",
      status: "Completed",
    },
    {
      degree: "HSC (12th)",
      field: "Sri Chaitanya Institute, Hyderabad",
      institution: "Percentage: 85%",
      year: "2020",
      icon: "📚",
      status: "Completed",
    },
      ...
      <div className="container mx-auto relative z-10 max-w-7xl">
        ...
        >
          ...
          <p className="text-gray-300 max-w-3xl mx-auto text-sm sm:text-base md:text-lg leading-relaxed mb-3 sm:mb-4 px-2">
            React.js Developer — Frontend Engineer — MERN Stack Developer (Fresher)
          </p>
          <p className="text-purple-400 max-w-2xl mx-auto text-xs sm:text-sm md:text-base leading-relaxed font-medium px-2">
            Skilled in responsive UI, REST API integration, Redux/Zustand state management, and clean code. Passionate about building production-ready web apps.
          </p>
        </div>
