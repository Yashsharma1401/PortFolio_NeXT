...
const Header = () => {
  ...
  // Navigation items for Yash Sharma portfolio
        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center space-x-2">
            <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
              <span className="text-white font-bold text-sm sm:text-lg">YS</span>
            </div>
            <span className="text-white font-bold text-lg sm:text-xl">Yash Sharma</span>
          </div>
