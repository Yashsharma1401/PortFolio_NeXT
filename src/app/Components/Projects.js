  ...
  const projects = [
    {
      ...
      description:
        "Built a full-stack blogging platform with authentication and CRUD using the MERN stack. Integrated REST APIs, MongoDB, and implemented JWT for secure user sessions. Designed a responsive UI with Tailwind CSS.",
      tech: [
        "MongoDB",
        "Express.js",
        "React.js",
      ...
      github: "https://github.com/Yashsharma1401",
    },
    {
      id: 2,
      title: "FlagFacts - Country Information App",
      description:
        "Developed a real-time country data dashboard using Axios and RESTful APIs. Added search, sort, and filter functions for 200+ countries and implemented React Router with an accessibility score of 95% on Lighthouse.",
      tech: ["React.js", "Axios", "REST API", "React Router", "Tailwind CSS"],
      github: "https://github.com/Yashsharma1401",
    },
    {
      id: 3,
      title: "Zaminwala Real Estate Website",
      description:
        "Built a responsive property listing site with reusable components and route-based filtering. Applied mobile-first principles and optimized performance and layout for better engagement.",
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <button className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-medium rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-500/25"
            onClick={() => window.open('https://github.com/Yashsharma1401', '_blank')}>
            View More Projects
          </button>
        </div>
      </div>
